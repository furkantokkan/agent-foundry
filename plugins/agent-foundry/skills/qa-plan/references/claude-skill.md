...
|-------|------|------------------------|------------------------------|
| [story title] | Logic | EditMode test — `Assets/Tests/EditMode/[System]/` | None |
| [story title] | Integration | PlayMode/EditMode integration — `Assets/Tests/PlayMode/[System]/` | Smoke check |
...
### [Story Title] — [Type]
**Test file path**: `Assets/Tests/[EditMode|PlayMode]/[System]/[StoryName]Tests.cs`
**What to test**:
...
- [ ] Code reviewed (via `/game-code-review` or documented peer review)
...
options:
  ...
  - "Also back-fill test case specs into each story file's ## QA Test Cases section (Recommended — enables /dev-story and /game-code-review traceability)"
```
