...
2. **Gather context**:
   ...
   - Read project-owned audio assets/lists in `Assets/Game/Audio/`; exclude vendor content
...
- Is the proposed Unity Audio Mixer/middleware integration consistent with the
  existing project stack and package approvals?
- Which Unity audio component/asset boundaries and serialized owner are required?
...
Each agent receives allowed/forbidden paths and an output contract. Low-risk
approved docs/code are autonomous. AudioMixer assets, scenes, prefabs, import
settings, middleware packages, and project settings have one writer and require
their medium/high-risk approval before mutation.
