...
- Glob `Assets/**/Enemies/**`, `Assets/**/Characters/**`
- Look for `.json`, `.asset`, `.prefab`, and `.yaml` data files defining entity stats
- Look for scene/prefab files in character subdirectories

**Items / Equipment / Loot:**
- Glob `Assets/**/Items/**`, `Assets/**/Equipment/**`, `Assets/**/Loot/**`
- Look for `.json` and `.asset` data files

**Abilities / Skills / Spells:**
- Glob `Assets/**/Abilities/**`, `Assets/**/Skills/**`, `Assets/**/Spells/**`
- Look for `.json` and `.asset` data files

**Dialogue / Conversations / Cutscenes:**
- Glob `Assets/**/*.dialogue`, `Assets/**/*.csv`, `Assets/**/*.ink`, and
  Timeline assets under `Assets/`

**Quests / Missions:**
- Glob `Assets/**/Quests/**`, `Assets/**/Missions/**`
...
Present the gap table and summary, then write the full report to
`docs/content-audit-[YYYY-MM-DD].md` as this invocation's declared output.
