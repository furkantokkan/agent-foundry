...
Discover the project-owned asset roots under `Assets/` first, then scan the
relevant target with Glob. Prefer these canonical locations when present:

- `Assets/Game/Art/**/*` for art assets
- `Assets/Game/Audio/**/*` for audio assets
- `Assets/Game/VFX/**/*` for VFX assets
- `Assets/Game/Shaders/**/*` for shaders
- `Assets/Game/Data/**/*` for data assets and ScriptableObjects

Do not assume third-party content under `Assets/Plugins/`, `Assets/ThirdParty/`,
or package content under `Packages/` is owned by the story. Report it separately
unless the task explicitly includes that dependency.
