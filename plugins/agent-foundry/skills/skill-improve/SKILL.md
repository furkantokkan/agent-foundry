...
Improve one skill with a scoped test-fix-retest loop, including checkable
completion, single-source routing, predictable repeated invocation, and
instruction-hygiene checks.
