...
name: skill-test
description: >-
  Validate skill files for structural compliance, checkable completion, single-source routing, invocation policy, and instruction hygiene; keep instruction conformance distinct from executed Unity evidence.
---

# Skill Test

Codex port of Claude Code Game Studios /skill-test.
...
Validate skills with 10 structural checks plus instruction-conformance,
category, audit, and externally orchestrated Unity evidence modes.
