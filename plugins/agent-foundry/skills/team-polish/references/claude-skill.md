...
Each agent receives base/worktree, allowed/forbidden paths, and an output
contract. Read-only profiling/review may run in parallel. Fixes sharing a story
or asset hand off sequentially; scenes, prefabs, materials, VFX, audio assets,
and settings have one writer and their risk-tier approval.
