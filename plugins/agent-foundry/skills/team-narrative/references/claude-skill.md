...
drafts may run in parallel, but one compiler writes each canon/dialogue artifact.
Low-risk approved text writes are autonomous; localization schemas, public data
contracts, and serialized Unity assets use the appropriate approval gate.
