...
Translate approved GDDs and architecture into optional grouping epics. An epic
is never implemented directly and does not require child story files. Create
one `create-task` contract per independently verifiable deliverable.
