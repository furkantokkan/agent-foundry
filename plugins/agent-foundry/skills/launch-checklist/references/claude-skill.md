...
If not in dry-run mode, write
`production/releases/launch-checklist-[date].md` as the declared low-risk
artifact. Launch/publishing actions still require exact approval.
