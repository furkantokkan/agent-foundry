...
All Unity shader files must follow these standards to maintain
...
- Use project prefixes such as `SG_`, `SH_`, `CS_`, and `VFX_` consistently.

## Code Quality
- All uniforms/parameters must have descriptive names and appropriate hints
- Group related material and graph parameters using Unity categories and headers.
