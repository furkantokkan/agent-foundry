...
### Source Code
- **Status**: [X%] complete
- **Files Found**: [N] C# source files in `Assets/Game/`
- **Major Systems Identified**:
  - ✅ [System 1] (`Assets/Game/[Path]/`) — [brief status]
  - ✅ [System 2] (`Assets/Game/[Path]/`) — [brief status]
  - ⚠️  [System 3] (`Assets/Game/[Path]/`) — [issue or incomplete]
- **Key Gaps**:
...
- **Test Files**: [N] in `Assets/Tests/EditMode/`, `Assets/Tests/PlayMode/`,
  and feature-local Unity test assemblies
- **Coverage by System**:
...
### Prototypes
- **Unity Implementations**: [N] in `Assets/Prototypes/`
- **Reports / Sandboxes**: [N] in `production/prototypes/`
...
Assets/Tests/    [N] EditMode/PlayMode test files
Assets/Prototypes/        [N] Unity implementation roots
production/prototypes/    [N] reports / sandbox roots
```
