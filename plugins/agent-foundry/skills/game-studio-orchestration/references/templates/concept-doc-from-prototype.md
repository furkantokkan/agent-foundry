...
**Prototype Path**: `Assets/Prototypes/[Name]Concept/` (Unity) or
`production/prototypes/[name]-concept/sandbox/` (HTML/Paper)
**Date**: [YYYY-MM-DD]
**Creator**: [User name]
...
**Code**:
- Location: `Assets/Prototypes/[Name]Concept/Scripts/`
- Status: [Archival | Partial reuse | Full reuse]

**Art/Audio** (if any):
- Location: `Assets/Prototypes/[Name]Concept/Content/`
...
*This concept document was generated by `/reverse-document concept Assets/Prototypes/[Name]Concept`*
