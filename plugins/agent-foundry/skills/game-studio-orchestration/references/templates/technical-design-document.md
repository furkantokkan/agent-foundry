...
| **APIs Depended On** | [Specific Unity/package classes and members with pinned versions] |
| **References Consulted** | [Pinned official/local Unity references, e.g. `docs/engine-reference/unity/VERSION.md`] |
