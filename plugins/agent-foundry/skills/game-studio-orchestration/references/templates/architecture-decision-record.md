...
| Field | Value |
|-------|-------|
| **Engine** | Unity [exact version from `ProjectSettings/ProjectVersion.txt`] |
...
| **References Consulted** | [Pinned Unity/package references, e.g. `docs/engine-reference/unity/VERSION.md`] |
...
|-------------|--------|-------------|--------------------------|
| [e.g. `design/gdd/combat.md`] | [e.g. Combat] | [e.g. "Hit detection must resolve within one fixed step"] | [e.g. "The combat service runs Unity Physics non-alloc queries during the owned fixed-step update"] |
