...
|-------|------|------------------------|------------------------------|
| [story title] | Logic | EditMode — `Assets/Tests/EditMode/[System]/` | None |
...
**Test file path**: `Assets/Tests/EditMode/[System]/[StoryName]Tests.cs`
...
**Test file path**: `Assets/Tests/PlayMode/[System]/[StoryName]Tests.cs`
