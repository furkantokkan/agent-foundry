...
> *Unity prototype code location: `Assets/Prototypes/[ConceptName]Concept/`*
> *HTML/Paper sandbox location (when applicable): `production/prototypes/[concept-name]-concept/sandbox/`*
