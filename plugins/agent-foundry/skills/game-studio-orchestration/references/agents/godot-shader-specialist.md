...
maxTurns: 20
---
> **INACTIVE LEGACY REFERENCE:** This repository is Unity-only. If invoked,
> return `BLOCKED` and route to `unity-shader-specialist`; do not read or write project files.
