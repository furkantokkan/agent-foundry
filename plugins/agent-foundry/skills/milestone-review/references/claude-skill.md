...
Write `production/milestones/[milestone-name]-review.md` as this review's
declared low-risk output.

Write the file, creating the directory if needed. Verdict: **COMPLETE** —
milestone review saved. Return **BLOCKED** only if required evidence or the
declared output scope is unavailable.
