...
- For programmers: scan `Assets/Game/`, relevant `.asmdef` files, and composition roots
...
- For QA: scan `Assets/Tests/EditMode/`, `Assets/Tests/PlayMode/`, and feature-local test assemblies
...
Write `production/onboarding/onboard-[role]-[date].md` as the invocation's
declared low-risk onboarding artifact.
